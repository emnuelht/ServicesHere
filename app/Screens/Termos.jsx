        ...
        <View>
            ...
            <SafeAreaView style={{paddingHorizontal: 20, marginTop: 20, marginBottom: 40}}>
                <ScrollView>
                    ...
                    <Text>Empregamos medidas de segurança razoáveis para proteger suas informações pessoais contra acesso não autorizado, divulgação ou destruição. No entanto, é importante lembrar que nenhuma transmissão de dados pela internet é 100% segura.</Text>

                    <Text style={{fontWeight: 'bold', fontSize: 17, marginTop: 20}}>6. Direitos dos Usuários</Text>
                    <Text>Você tem o direito de acessar, corrigir ou excluir suas informações pessoais. Para exercer esses direitos, entre em contato conosco através dos meios fornecidos na seção de contato.</Text>
                    ...
                    <Text style={{marginBottom: 100}}>Se você tiver alguma dúvida sobre esta Política de Privacidade ou sobre a coleta e uso de suas informações pessoais, entre em contato conosco através do e-mail: [seu-email@dominio.com].</Text>
